  ...
  <section class="contact_section ">
    ...
    <div class="container container-bg">
      <div class="row">
        ...
        <!--formulaire modif témoignages-->
          <form action="../model/model_modifier_temoignages.php" method="post">
            <div>
              <input type="text" name="nom_tem" placeholder="Nom" value="<?php echo $temoignage->nom_tem; ?>"/>
            </div>
            <div>
              <input type="text" name="prenom_tem" placeholder="Prenom" value="<?php echo $temoignage->prenom_tem; ?>"/>
            </div>
            <div>
              <input type="text" name="message_tem" class="message-box" placeholder="Message" value="<?php echo $temoignage->message_tem; ?>"/>
            </div>
            <div>
              <input name="id_tem" type="hidden" value="<?php echo $temoignage->id_tem; ?>">
            </div>
            <div class="d-flex ">
              <button type="button">
                Ajouter
        ...
        <!--Fin formulaire modif témoignages--> 
        </div>
      </div>
    </div>
  </section>
